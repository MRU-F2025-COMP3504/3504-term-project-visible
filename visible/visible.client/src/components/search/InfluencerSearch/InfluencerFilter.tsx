...
//define that InfluencerFilter is looking for a setter function
type influencerFilterProps = {
  setSearchKeyword: Dispatch<SetStateAction<string>>;
};

//InfluencerFilter component implements the form to filter the influencer list
const InfluencerFilter = ({ setSearchKeyword }: influencerFilterProps) => {
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-[600px] bg-black!">
          ...
          <DialogDescription hidden={true}>
            Provide keyword to filter influencers by attributes.
          </DialogDescription>
          <form
            // Submit Function
            onSubmit={(e) => {
